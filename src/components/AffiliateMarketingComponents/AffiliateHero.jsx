        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="mt-8 text-lg leading-8 text-gray-200 max-w-xl">
              Expand your reach, acquire quality customers, and maximize your
              ROI with data-driven affiliate campaigns. We connect your brand
              with trusted publishers to deliver measurable business growth.
            </p>
